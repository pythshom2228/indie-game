...
//     return _position; 
// }
float InteractiveObject::getInteractionRadius() const {
    return _interactionRadius;
}

void InteractiveObject::setPosition(const Vector2 &newPosition) {
    _position = newPosition;
}
void InteractiveObject::setInteractionRadius(float radius) { 
